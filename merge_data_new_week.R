mapping <- readRDS("data/mapping_to_w39.rds")
mapping <- mapping[,-c(17,18)]

nweek <- readxl::read_xlsx("data/tuan 40.xlsx")
nweek <- nweek %>% filter(NoiOHienTai_SauKhiSapNhap_CityId=="Thành Phố Hồ Chí Minh")
nweek <- nweek %>% select(HoTen,NgaySinh,GioiTinh, SDT, NoiOHienNay, 
                          ...
                          ChanDoanBenhKemTheo, NgayKhoiPhat)
...
## lưu file dữ liệu
saveRDS(df_clean, "data/mapping_to_w39.rds")
